 ...
 */
public abstract class FirebaseQueryAdapter<T> extends BaseAdapter {

    private Query mRef;
    private List<TaskModel> mModels;
    private List<String> mKeys;
    private ChildEventListener mListener;
    private Context mContext;

    public FirebaseQueryAdapter(Context context) {
        Firebase mFirebaseRef = new Firebase(BuildConfig.FIREBASE_URL);
        this.mRef = mFirebaseRef.limit(50);
        ...
        mListener = this.mRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                ...
                String key = dataSnapshot.getKey();
                TaskModel newModel = dataSnapshot.getValue(TaskModel.class);
    ...
    */
    public void updateQueryToShowConflictingRevisions(final Database.ChangeEvent event) {
        ...
        ((Activity) FirebaseQueryAdapter.this.mContext).runOnUiThread(new Runnable() {
            @Override
            public void run() {
                notifyDataSetChanged();
            }
